...
nn.layers.append(FCLayer(batch_size, 3072, 800, 0.0000001, "relu"))
nn.layers.append(FCLayer(batch_size, 800, 10, 0.01, "tanh"))
...
f = open("mlp_stat" + str(key) + ".dat", "wb")
cPickle.dump({
...
f.close()
f = open("mlp_model" + str(key) + ".dat", "wb")
cPickle.dump(nn, f)
f.close()
print "KEY: " + str(key)
